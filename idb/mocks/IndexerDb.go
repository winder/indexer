...
// SetNextRoundToAccount provides a mock function with given fields: uint642
func (_m *IndexerDb) SetNextRoundToAccount(uint642 uint64) error {
	ret := _m.Called(uint642)
